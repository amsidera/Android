...
//Activity que muestra como usar la aplicacion
public class ComoUsarApp extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.comousarapp);
		// Definimos actionBar
		android.app.ActionBar actionBar = getActionBar();
		// Título de la Activity
		actionBar.setTitle("Como usar la aplicación");
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		...
		switch (arg2) {
		case 0:
			Ctres(); // Lanzamos una nueva Activity
			break;
		case 1:
			Ccinco();
			break;
	...
	// getMenuInflater().inflate(R.menu.pastilla2, menu);
	// return true;
	// }
